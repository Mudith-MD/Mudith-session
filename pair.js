...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            ...
            password: 'mudith@27_' // Your Mega A/c Password Here
        }).ready;
...
router.get('/', async (req, res) => {
    ...
    async function Mudith_PAIR_CODE() {
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Mudith-MD_V1~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🚀 _Thanks for choosing Mudith-MD_V1 — Let the automation begin!_ ✨`;
