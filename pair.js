...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'botmudith2007@gmail.com', // Your Mega A/c Email Here
            password: 'Mudith-MD27' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Mudith_King~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of Mudith_King.
...
🚀 _Thanks for choosing Mudith_King — Let the automation begin!_ ✨`;

                    await Mudith.sendMessage(Mudith.user.id, { text: MUDITH_TEXT }, { quoted: session });

                    await delay(100);
                    await Mudith.ws.close();
